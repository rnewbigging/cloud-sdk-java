...
1.  **[Project activity](#project-activity)**: **9.08** (weight is 0.5)
...
1.  [Suggest a security policy for the project](https://github.com/rnewbigging/cloud-sdk-java/security/policy)
...
Score: **9.08**, confidence is 10.0 (max), weight is 0.5 (medium)
